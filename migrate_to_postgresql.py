    ...
    with postgres_app.app_context():
        ...
        for user in users:
            new_user = User(
                ...
                rudraksha_5_mukhi_access=user.rudraksha_5_mukhi_access,
                ...
                rudraksha_5_mukhi_completed_at=user.rudraksha_5_mukhi_completed_at,
                ...
                rudraksha_5_mukhi_started_at=user.rudraksha_5_mukhi_started_at,
